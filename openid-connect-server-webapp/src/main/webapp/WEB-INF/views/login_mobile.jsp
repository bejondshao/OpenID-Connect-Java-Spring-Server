...
$(document).ready(function() {
	...
	$('#<c:out value="${ login_hint != null ? 'j_sms' : 'j_mobile' }" />').focus();
});
			...
			<form action="${ config.issuer }${ config.issuer.endsWith('/') ? '' : '/' }login" method="POST">
				...
				<div>
					<div class="input-prepend input-block-level">
						...
						<input type="text" placeholder="<spring:message code="login.sms"/>" autocorrect="off" autocapitalize="off" autocomplete="off" spellcheck="false" id="j_sms" name="sms">
					</div>
				</div>
				<div>
